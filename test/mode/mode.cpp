...
TEST(Ecb, EncryptDecryptAes128)
{
    ...
    ecb_encrypt<aes128>(test_key, test_msg, out, sizeof(test_msg));
    compare(out, exp);
    ecb_decrypt<aes128>(test_key, out, out, sizeof(out));
    compare(out, test_msg);
}
...
//     cbc_encrypt<aes128>(test_key, iv, test_msg, out, sizeof(test_msg));
//     compare(out, exp, sizeof(out));
//     cbc_decrypt<aes128>(test_key, iv, out, out, sizeof(out));
//     compare(out, test_msg, sizeof(test_msg));
// }
...
//     cfb_encrypt<aes128>(test_key, iv, test_msg, out, sizeof(test_msg));
//     compare(out, exp, sizeof(out));
...
//     ofb_encrypt<aes128>(test_key, iv, test_msg, out, sizeof(test_msg));
//     compare(out, exp, sizeof(out));
...
//     ctr_encrypt<aes128>(test_key, iv, test_msg, out, sizeof(test_msg));
